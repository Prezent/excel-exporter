...
class Exporter
{
    ...
    /**
     * Convert PHPExcel formats to PHPSpreadsheet formats, for BC
     *
     * @param string $format
     * @return string
     */
    ...
    {
        if (in_array($format, array_keys($this->formatMapping))) {
            @trigger_error(
                'Using PHPExcel formats is deprecated since version 1.2 of the library. Use PHPSpreadsheet formats instead',
                E_USER_DEPRECATED
            );
